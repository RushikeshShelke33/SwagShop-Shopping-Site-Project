...
# related to end front end media img related config
...
# authentication form using bootstrap classes we use own template and validation code of inbuilt lib
# accounts/login will educe future errors
