...
# user should be redirected to upon successful authentication is stored
# used to secure views in your web applications by forcing the client to authenticate with a valid logged-in User.
...
class ProfileView(View):
    def get(self,request):
        ...
        # print('USERRRRRRRRRRRRRRR',user,userid)
